                        ...
                        <div class="d-flex align-items-center justify-content-between mb-2">
                            ...
                            <div>
                                <img class="wd-100 rounded-circle"
                                    src="{{ !empty($profile->profile_img) ? url('upload/user_img/' . $profile->profile_img) : url('upload/no_image.jpg') }}"
                                    alt="profile">
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('admin.profile.store') }}" class="forms-sample"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="info" class="form-control" id="exampleInputUsername1"
                                        autocomplete="off" value="{{ $profile->info }}">
                                </div>

                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Twitter Link </label>
                                    <input type="text" name="twitter_link" class="form-control"
                                        id="exampleInputUsername1" autocomplete="off" value="{{ $profile->info }}">
                                </div>

                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Photo </label>
                                    <input class="form-control" name="profile_img" type="file" id="image">
                                </div>
