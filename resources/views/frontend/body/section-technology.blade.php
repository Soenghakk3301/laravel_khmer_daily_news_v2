@php
    $technews = App\Models\NewsPost::where('status', 1)
        ->where('category_id', 3)
        ->latest()
        ->limit(4)
        ->get();
...
<section class="bg-gray-100 py-8 sm:bg-white px-3 lg:mx-auto sm:px-10 md:px-24 lg:px-44 xl:px-50">
    <!-- herder -->
    <header class="mb-5">
    ...
    <!-- body -->
    <div class="grid grid-cols-1 gap-x-3 gap-y-8 sm:grid-cols-4">
