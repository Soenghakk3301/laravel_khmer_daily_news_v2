                    ...
                    <div class="card-body">
                        ...
                        <form id="myForm" method="post" action="{{ route('update.news.post') }}"
                            ...
                            <div class="row">
                                ...
                                <div class="row form-group mb-5 d-flex align-items-center">
                                ...
                                <div class="row form-group mb-5 d-flex align-items-center">
                                    ...
                                    @foreach ($newspost->multiImage as $img)
                                        <div class="form-group col-6 mb-3">
                                            <label for="example-fileinput" class="form-label">News Post Multi Image</label>
                                            <input type="file" name="image_mul" id="image" class="form-control">
                                        </div>

                                        <div class="form-group col-md-6">
                                            <label for="example-fileinput" class="form-label"> </label>
                                            <img id="showImage" src="{{ asset($img->news_post_multi_photo_name) }}"
                                                class="rounded-circle avatar-lg img-thumbnail" alt="profile-image">
                                        </div>
                                    @endforeach
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <textarea name="news_description">
                                             {!! $newspost->news_description !!}
                                        </textarea>
                                </div>
                                <div class="col-12 mb-3">
                                    <label for="inputEmail4" class="form-label">News Details 2</label>
                                    <textarea name="news_description_2">
                                             {!! $newspost->news_description_2 !!}
                                        </textarea>
                                </div>
                                <div class="col-12 mb-3">
                                    <label for="inputEmail4" class="form-label">News Details 3</label>
                                    <textarea name="news_description_3">
                                             {!! $newspost->news_description_3 !!}
                                        </textarea>
                                </div>
